 ...
 */
final class Version20231230173624 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Create Books and Authors tables';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE author (id INT NOT NULL DEFAULT nextval(\'author_id_seq\'), last_name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, patronymic VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE book (id INT NOT NULL DEFAULT nextval(\'book_id_seq\'), title VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, image VARCHAR(255) NOT NULL, publish_date DATE NOT NULL, PRIMARY KEY(id))');
